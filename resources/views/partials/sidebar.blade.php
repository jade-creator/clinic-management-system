    ...
    <ul class="c-sidebar-nav">
        ...
        @else
            ...
            <li class="c-sidebar-nav-item c-sidebar-nav-dropdown">
                ...
                <ul class="c-sidebar-nav-dropdown-items">
                    <li class="c-sidebar-nav-item">
                        <a class="c-sidebar-nav-link" href="{{ route('doctors.view') }}">
                            Doctor
                        </a>
                    </li>
                    <li class="c-sidebar-nav-item">
                        <a class="c-sidebar-nav-link" href="{{ route('receptionists.view') }}">
                            Receptionist
                        </a>
                    </li>
                    <li class="c-sidebar-nav-item">
                        <a class="c-sidebar-nav-link" href="{{ route('patients.view') }}">
                            Patient
                        </a>
                    </li>
                    <li class="c-sidebar-nav-item">
                        <a class="c-sidebar-nav-link" href="{{ route('users.view') }}">
                            View All
                        </a>
                    </li>
                </ul>
