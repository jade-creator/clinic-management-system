<div class="px-3 px-sm-4">
    ...
    <form method="post" wire:submit.prevent="create">
        ...
        <div class="form-group">
            ...
            <input type="number" class="form-control @error('stock.quantity') is-invalid @enderror" id="treatment_quantity" name="treatment_quantity" autofocus wire:model.defer="stock.quantity" wire:loading.attr="disabled">
