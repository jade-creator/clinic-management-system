        ...
        <x-slot name="button">
            <a href="{{ route('histories.add') }}">
                <button class="btn btn-primary">
                    ...
                    <span class="d-none d-md-inline-block">Add Case History</span>
                </button>
            </a>
        </x-slot>
                    ...
                    @forelse ($histories as $history)
                        <tr>
                            ...
                            <td class="text-center">
                                ...
                                <button class="btn text-danger rounded-circle p-1 mx-1" data-toggle="tooltip" data-placement="top" title="Delete" wire:click="destroy({{ $history }})">
