            ...
            <div class="col-sm-6 col-lg-3 mb-4">
                <div class="card text-white bg-white shadow">
                    <div class="card-body card-body pb-3 d-flex align-items-start">
                        ...
                        <div class="text-dark">
                            <div class="h5">{{ $this->totalAppointments }}</div>
            ...
            <div class="col-sm-6 col-lg-3">
                <div class="card text-white bg-white shadow">
                    <div class="card-body card-body pb-3 d-flex align-items-start">
                        ...
                        <div class="text-dark">
                            <div class="h5">{{ $this->totalPrescriptions }}</div>
            ...
            <div class="col-sm-6 col-lg-3">
                <div class="card text-white bg-white shadow">
                    <div class="card-body card-body pb-3 d-flex align-items-start">
                        ...
                        <div class="text-dark">
                            <div class="h5">{{ $this->totalHistories }}</div>
            ...
            <div class="col-sm-6 col-lg-3">
                <div class="card text-white bg-white shadow">
                    <div class="card-body card-body pb-3 d-flex align-items-start">
                        ...
                        <div class="text-dark">
                            <div class="h5">{{ $this->totalDocuments }}</div>
            ...
            <div class="col-sm-6 col-lg-3">
                <div class="card text-white bg-white shadow">
                    <div class="card-body card-body pb-3 d-flex align-items-start">
                        ...
                        <div class="text-dark">
                            <div class="h5">{{ $this->totalPayments }}</div>
            ...
            <div class="col-sm-6 col-lg-3">
                <div class="card text-white bg-white shadow">
                    <div class="card-body card-body pb-3 d-flex align-items-start text-dark">
                        ...
                        <div>
                            <div class="h5">{{ $this->totalUsers }}</div>
                            <div>Total Users</div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-sm-6 col-lg-3">
                <div class="card text-dark bg-white shadow">
                    <div class="card-body card-body pb-3 d-flex align-items-start">
                        ...
                        <div class="text-dark">
                            <div class="h5">{{ $this->totalStocks }}</div>
            ...
            <div class="col-sm-6 col-lg-3">
                <div class="card text-white bg-white shadow">
                    <div class="card-body card-body pb-3 d-flex align-items-start">
                        ...
                        <div class="text-dark">
                            <div class="h5">{{ $this->totalTreatments }}</div>
