<div class="px-3 px-sm-4">
    ...
    <form method="post" wire:submit.prevent="create">
        ...
        <div class="form-group">
            ...
            <textarea class="form-control @error('treatment.description') is-invalid @enderror" id="description" name="description" placeholder="..." required autofocus wire:model.defer="treatment.description" wire:loading.attr="disabled"></textarea>
