            ...
            <div class="col-sm-6 col-lg-3">
                <div class="card text-white bg-primary">
                    <div class="card-body card-body pb-3 d-flex align-items-start">
                        ...
                        <div>
                            <div class="text-value-lg">{{ $this->totalBillAmount }}</div>
            ...
            <div class="col-sm-6 col-lg-3">
                <div class="card text-white bg-info">
                    <div class="card-body card-body pb-3 d-flex align-items-start">
                        ...
                        <div>
                            <div class="text-value-lg">{{ $this->upcomingAppointment->count() }}</div>
            ...
            <div class="col-sm-6 col-lg-3">
                <div class="card text-white bg-warning">
                    <div class="card-body card-body pb-3 d-flex align-items-start">
                        ...
                        <div>
                            <div class="text-value-lg">{{ $this->prescriptions->count() }}</div>
            ...
            <div class="col-sm-6 col-lg-3">
                <div class="card text-white bg-danger">
                    <div class="card-body card-body pb-3 d-flex align-items-start">
                        ...
                        <div>
                            <div class="text-value-lg">{{ $this->caseHistories->count() }}</div>
