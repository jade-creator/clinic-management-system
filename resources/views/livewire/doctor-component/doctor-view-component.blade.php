<div class="px-3 px-sm-4">
    <x-table title="Doctors' History" placeholder="ID, Name">
        <x-slot name="button">
        </x-slot>
            ...
            <table class="table table-hover table-bordered table-light">
                ...
                <tbody>
                    @forelse ($doctors as $doctor)
                        <tr>
                            <td class="text-left" scope="row">{{ $doctor->id ?? 'N/A' }}</td>
                            <td class="text-left">{{ $doctor->user->name ?? 'N/A' }}</td>
                            <td class="text-center">{{ $doctor->appointments->count() ?? 'N/A' }}</td>
                            <td class="text-center">{{ $doctor->prescriptions->count() ?? 'N/A' }}</td>
                            <td class="text-center">
                                <a class="text-decoration-none" href="{{ route('users.view', ['search' => $doctor->user->name]) }}">
                                ...
                                <a class="text-decoration-none" href="{{ route('prescriptions.view', ['search' => $doctor->user->name]) }}">
                                ...
                                <a class="text-decoration-none" href="{{ route('appointments.view', ['search' => $doctor->user->name]) }}">
                    ...
                    @empty
                        <tr>
                            <td scope="row" colspan="5" class="text-center">No doctors found.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
